...
ames_test = full_training %>% filter(Id = 9,14,15,16,17,27,29,30,32,36,44,50,51,52,53,60,61,70,72,74,76,80,85,88,92,93,94,98,101,
...
ames_training = ames_test %>% filter(Id %notin% ames_test$Id)                     
