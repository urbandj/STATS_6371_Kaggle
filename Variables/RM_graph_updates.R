...
ggplot(data = training_data, aes(x=WoodDeckSF_group, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$WoodDeckSF_group]), 
                                           max(training_data$SalePrice[training_data$WoodDeckSF_group]))) +
...
ggplot(data = training_data, aes(x=OpenPorchSF_group, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$OpenPorchSF]), 
                                           max(training_data$SalePrice[training_data$OpenPorchSF]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=EnclosedPorch_group, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$EnclosedPorch_group]), 
                                           max(training_data$SalePrice[training_data$EnclosedPorch_group]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=TotalBath, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$TotalBath]), 
                                           max(training_data$SalePrice[training_data$TotalBath]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=BedroomAbvGr4plus, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$BedroomAbvGr4plus]), 
                                           max(training_data$SalePrice[training_data$BedroomAbvGr4plus]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=KitchenQual, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$KitchenQual]), 
                                           max(training_data$SalePrice[training_data$KitchenQual]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=TotRmsAbvGrd10plus, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$TotRmsAbvGrd10plus]), 
                                           max(training_data$SalePrice[training_data$TotRmsAbvGrd10plus]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=FireplaceY, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$FireplaceY]) +
                                             max(training_data$SalePrice[training_data$FireplaceY]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=GarageType, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$GarageType]), 
                                           max(training_data$SalePrice[training_data$GarageType]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
training_data$GarageTypeY <- ifelse(training_data$GarageType == 'Attchd' | training_data$GarageType == 'BuiltIn', 1, 0)  
ggplot(data = training_data, aes(x=GarageTypeY, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$GarageTypeY]) +
                                             max(training_data$SalePrice[training_data$GarageTypeY]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))

##### strange may want check buckets
#Garage Year Built
training_data$GarageYrBlt %na<-% 0
ggplot(data = training_data, aes(x=GarageYrBlt, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$GarageYrBlt]) +
                                             max(training_data$SalePrice[training_data$GarageYrBlt]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
#ggplot(data = training_data, aes(x=GarageCars3plus, y=SalePrice))+geom_point(stat ="identity")
ggplot(data = training_data, aes(x=GarageCars, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$GarageCars]) +
                                             max(training_data$SalePrice[training_data$GarageCars]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
training_data$GarageCond %na<-% 0
ggplot(data = training_data, aes(x=GarageCond, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$GarageCond]) + 
                                             max(training_data$SalePrice[training_data$GarageCond]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=PavedDrive, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$PavedDrive]) + 
                                             max(training_data$SalePrice[training_data$PavedDrive]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
# scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$PavedDriveY]) + 
#                                            max(training_data$SalePrice[training_data$PavedDriveY]))) +
#   scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=MSSubClass, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$MSSubClass]) + 
                                             max(training_data$SalePrice[training_data$MSSubClass]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=MSZoning, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$MSZoning]) + 
                                             max(training_data$SalePrice[training_data$MSZoning]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=LotFrontage, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$LotFrontage]) +
                                             max(training_data$SalePrice[training_data$LotFrontage]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=training_data$LotArea, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$LotArea]) +
                                             max(training_data$SalePrice[training_data$LotArea]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=training_data$LandSlope, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$LandSlope]) +
                                             max(training_data$SalePrice[training_data$LandSlope]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=training_data$Neighborhood, y=SalePrice))+geom_point(stat ="identity") +
  ...
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$Neighborhood]) +
                                             max(training_data$SalePrice[training_data$Neighborhood]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=training_data$OverallQual, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$OverallQual]) +
                                             max(training_data$SalePrice[training_data$OverallQual]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=training_data$OverallCond, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$OverallCond]) +
                                             max(training_data$SalePrice[training_data$OverallCond]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
training_data$YearBuilt[is.na(training_data$YearBuilt)] <- "NONE"
training_data$YearBuilt

ggplot(data = training_data, aes(x=YearBuilt, y=logSalePrice))+geom_point(stat ="identity") +
  theme(axis.text.x = element_text(angle = 90, hjust = 0, vjust=0.5)) +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$logSalePrice[training_data$YearBuilt]) +
                                             max(training_data$logSalePrice[training_data$YearBuilt]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=YearRemodAdd, y=logSalePrice))+geom_point(stat ="identity") +
  theme(axis.text.x = element_text(angle = 90, hjust = 0, vjust=0.5)) +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$logSalePrice[training_data$YearRemodAdd]) +
                                             max(training_data$logSalePrice[training_data$YearRemodAdd]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=MasVnrArea, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$MasVnrArea]) +
                                             max(training_data$SalePrice[training_data$MasVnrArea]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=training_data$ExterQual, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$ExterQual]) +
                                             max(training_data$SalePrice[training_data$ExterQual]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=ExterCond, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$ExterCond]) +
                                             max(training_data$SalePrice[training_data$ExterCond]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=BsmtQual, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$BsmtQual]) +
                                             max(training_data$SalePrice[training_data$BsmtQual]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=BsmtCond, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$BsmtCond]) +
                                             max(training_data$SalePrice[training_data$BsmtCond]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=BsmtExposure, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$BsmtExposure]) +
                                             max(training_data$SalePrice[training_data$BsmtExposure]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=BsmtFinType1, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$BsmtFinType1]) +
                                             max(training_data$SalePrice[training_data$BsmtFinType1]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=BsmtFinSF1, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$BsmtFinSF1]) +
                                             max(training_data$SalePrice[training_data$BsmtFinSF1]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=BsmtFinType2, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$BsmtFinType2]) +
                                             max(training_data$SalePrice[training_data$BsmtFinType2]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=BsmtUnfSF, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$BsmtUnfSF]) +
                                             max(training_data$SalePrice[training_data$BsmtUnfSF]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=TotalBsmtSF, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$TotalBsmtSF]) +
                                             max(training_data$SalePrice[training_data$TotalBsmtSF]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=HeatingQC, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$Heating]) +
                                             max(training_data$SalePrice[training_data$Heating]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=CentralAir, y=SalePrice))+geom_point(stat ="identity") +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
  scale_y_continuous(label=comma, limits=c(min(training_data$SalePrice[training_data$CentralAir]) +
                                             max(training_data$SalePrice[training_data$CentralAir]))) +
  scale_y_continuous(labels=dollar_format(prefix="$"))
...
ggplot(data = training_data, aes(x=training_data$Electrical, y=SalePrice))+geom_point(stat ="identity") +
  theme(axis.text.x = element_text(angle = 90, hjust = 0, vjust=0.5)) +
  scale_y_continuous(labels = function(x) format(x, scientific = FALSE)) +
